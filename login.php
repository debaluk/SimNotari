			...
			<div class="box-login">
				...
				<form class="form-login" method="POST" action="login_proses.php">
					<div class="errorHandler alert alert-danger no-display">
						<i class="fa fa-remove-sign"></i> Terjadi masalah login, silahkan cek kembali.
					</div>
					<fieldset>
						...
						<span class="errormess"></span></p>
						<div class="form-actions">
							
							<button type="submit" id="login" class="btn btn-bricky pull-right" >
